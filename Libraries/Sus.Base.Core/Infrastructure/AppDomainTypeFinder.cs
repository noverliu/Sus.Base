...
namespace Sus.Base.Core.Infrastructure
{
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft|^AjaxControlToolkit|^Antlr3|^Autofac|^AutoMapper|^Castle|^ComponentArt|^CppCodeProvider|^DotNetOpenAuth|^EntityFramework|^EPPlus|^FluentValidation|^ImageResizer|^itextsharp|^log4net|^MaxMind|^MbUnit|^MiniProfiler|^Mono.Math|^MvcContrib|^Newtonsoft|^NHibernate|^nunit|^Org.Mentalis|^PerlRegex|^QuickGraph|^Recaptcha|^Remotion|^RestSharp|^Rhino|^Telerik|^Iesi|^TestDriven|^TestFu|^UserAgentStringLibrary|^VJSharpCodeProvider|^WebActivator|^WebDev|^WebGrease|^NETStandard|^runtime|^Libuv|^Nuget";
        ...
        public virtual AssemblyLoadContext App
        {
            get { return AssemblyLoadContext.Default; }
        }
        ...
        {
            get { return string.IsNullOrEmpty(_config.assemblySkipLoadingPattern)?assemblySkipLoadingPattern:_config.assemblySkipLoadingPattern; }
        ...
        {
            get { return string.IsNullOrEmpty(_config.assemblyRestrictToLoadingPattern)? assemblyRestrictToLoadingPattern:_config.assemblyRestrictToLoadingPattern; }
        ...
        protected virtual void LoadMatchingAssemblies(string directoryPath)
        {
            ...
            foreach (string dllPath in Directory.GetFiles(directoryPath, "*.dll"))
            {
                try
                {
                    var an = AssemblyLoadContext.GetAssemblyName(dllPath);
                    if (Matches(an.FullName) && !loadedAssemblyNames.Contains(an.FullName))
                    {
                        App.LoadFromAssemblyName(an);
                    }
